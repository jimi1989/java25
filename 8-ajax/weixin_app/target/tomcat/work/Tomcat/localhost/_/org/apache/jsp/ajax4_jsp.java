 ...
 * Generated at: 2018-01-20 02:00:17 UTC
...
public final class ajax4_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("    \t\t\t\t\t\t\t\r\n");
      out.write("    \t\t\t\t\t\t\t// 创建文本子节点\r\n");
      out.write("    \t\t\t\t\t\t\tvar idNode = document.createTextNode(id); // 1\r\n");
      out.write("    \t\t\t\t\t\t\tvar nameNode = document.createTextNode(name); // jack\r\n");
      out.write("    \t\t\t\t\t\t\tvar ageNode = document.createTextNode(age); //23\r\n");
      out.write("    \t\t\t\t\t\t\t\r\n");
