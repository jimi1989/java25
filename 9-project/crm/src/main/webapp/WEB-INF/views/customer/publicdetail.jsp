            ...
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools">
                        ...
                        <a class="btn bg-purple btn-sm" href="/customer/my/edit?id=${customer.id}"><i class="fa fa-pencil"></i> 编辑</a>
                        <button class="btn bg-maroon btn-sm" id="myBtn"><i class="fa fa-recycle"></i> 认领</button>
